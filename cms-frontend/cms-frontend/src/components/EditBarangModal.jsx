...
import '../css/EditBarangModal.css'; // 🍏 IMPORT FILE CSS BARU LU DI SINI, CUY!
...
export default function EditBarangModal({ isOpen, onClose, barangData, onRefresh }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const result = await barangService.update(formEdit.id, formEdit);
  ...
  return (
    /* 🍏 MEMAKAI CLASS DARI FILE CSS BIASA */
