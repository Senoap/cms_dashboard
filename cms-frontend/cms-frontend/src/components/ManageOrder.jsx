...
function ManageOrder({
  ...
  const handleAddToCart = (e) => {
    e.preventDefault();
    if (!selectedBarangId || !jumlah || jumlah <= 0) {
    ...
    // Reset input barang & kuantitas bawaan props
    setSelectedBarangId('');
    setJumlah('');
  };
      ...
      <div className="form-container-premium" style={{ maxWidth: '850px' }}>
        ...
        <div className="form-body-premium">
          ...
          <form onSubmit={(e) => {
            ...
            // Oper data beserta isi cart dan grand total ke parent
            onOrderSubmit(e, { cart, grandTotal, setCart });
          }}>
